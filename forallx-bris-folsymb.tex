...
\end{center}
	...
	In fact, this is logically equivalent to $\exists x(Dx\eand\enot Ex)$: there is some dog which is not enthusiastic. Symbolising it this alternative way would be marked correctly in an exam, but it is perhaps less natural than $\enot\forall$. 
