...
Arguments for which there is no interpretation that respects all conceptual/meaning connection between the various words of our language are sometimes called \define{conceptually validity} and sometimes you'll find the term `validity' used in this sense in the literature . For example, the arguments
