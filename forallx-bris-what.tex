...
Some of the answers to the practice questions are in Appendix \ref{ch.answers}, but it is important to first try yourself. The answers are provided on a best-endeavours basis. There will be gaps and mistakes. Questions with answers are indicated with stars. Mistakes can be reported to \MaintainerEmailLink.
