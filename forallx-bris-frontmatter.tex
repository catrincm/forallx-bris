...
\vfill \noindent Links:
\begin{itemize}
	\item \href{\URLforEditionVersions/forallxbris.pdf}{\iffinalversion Final \else Most recent \fi version of textbook for \AcademicYearText}
	\item \href{\URLforEditionVersions/forallxbris-accessible.pdf}{Accessibility formatting of \iffinalversion final \else most recent \fi version of textbook for \AcademicYearText}\\Designed with students in dyslexia in mind. \\Adopted from Richard Zach (see \href{https://richardzach.org/2017/11/making-an-accessible-open-logic-textbook-for-dyslexics/}{discussion}).
	\item \href{\URL/editions/}{Other editions}
	\item \href{\URL}{Information}
\end{itemize}
\vfill
...
\noindent \footnotesize  \href{\URL}{\forallx:\texttt{Bristol}} is licensed under a \href{https://creativecommons.org/licenses/by-sa/4.0/}{Creative Commons Attribution-ShareAlike 4.0} license. 
