...
\begin{textblock*}{0in}(0in,0in)
  ...
  \begin{minipage}[b][\stockheight][s]{.9\stockwidth}
    \begin{raggedleft}
      ...
      \vfill
      Standard version at \url{https://catrincm.github.io/forallx-bris/forallxbris.pdf}
...
\
    ...
    \noindent Check for the most recent version at \url{https://catrincm.github.io/forallx-bris/forallxbris-withanswers.pdf}. \par 
\newpage\color{black}

\bigskip 
\thispagestyle{empty}
\noindent This book is provided on a best-endeavours basis.\\ Not all questions are available, and there may be mistakes.
\bigskip 
