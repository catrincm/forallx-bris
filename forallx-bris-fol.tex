...
If we want to symbolise
\begin{samplesent}
	\item\label{sent:lovesesomeonethemselves} Some dog likes playing with Finley.
\end{samplesent}
%We can do:
%\begin{equation*}
...
In chapter~{sec:SymbolisingSimpleFOL} we discussed how to symbolize sentences involving `only'. Consider the sentence:
\begin{samplesent}
