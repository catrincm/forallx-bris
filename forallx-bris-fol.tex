...
\begin{samplesent}
\item\label{folrocky} Rocky is strong
\item\label{folbiden} Joe Biden is a Democrat
\item\label{folpalin} Michael Palin is a member of Monty Python
\end{samplesent}
...
\begin{samplesent}
\item\label{foltower} The Tower of London is in England.
\end{samplesent}
...
Consider
\begin{samplesent}
\item\label{folbuses} Buses are red.
\end{samplesent}
...
We can symbolise
\begin{samplesent}
	\item\label{foland} Joe is happy and Katie is sad
\end{samplesent}
\begin{center}
	\begin{forest}
...
To symbolise
\begin{samplesent}
\item\label{folor} Joe and Katie are happy
\end{samplesent}
...
To symbolise
\begin{samplesent}
\item\label{folor} If Joe is happy, then Katie is too
\end{samplesent}
we observe that it can be naturally paraphrased as
...
\begin{samplesent}
\item\label{folcomplex} If Joe is not happy then Katie or Billy is sad.
\begin{center}
	\begin{forest}
...
\end{center}
%\item
%\item\label{folcomplex}  Katie and Billy is happy only if neither Joe nor Alice is sad.$$(Hk\eand Hb)\eif \enot (Sj\eor Sa)$$
\end{samplesent}
so giving the symbolisation: $$Hj\eif(Sk\eor Sb)$$

One final example. To symbolise:
\begin{samplesent}
\item\label{folredcar} Herbie is a red car
\end{samplesent}
...
To keep track of the gaps, we will label them. The labelling conventions we will adopt are best explained by example. Suppose we want to symbolize the following sentences:
	\begin{samplesent}
%		\item\label{terms3} Imre is at least as tall Karl.
%		\item\label{terms4} Imre is shorter than Karl.
...
\begin{samplesent}
\item\label{folbought} David bought the necklace for Victoria.
\end{samplesent}
...
\begin{samplesent}
\item\label{folmulti} The daughter of Gregor and Hilary is a friend of the first daughter of Bill and Michelle.
\end{samplesent}
...
Consider
\begin{samplesent}
\item\label{q.hat} Everyone wears a funny hat
\end{samplesent}
...
\begin{samplesent}
\item\label{q.hat} Everyone is happy and wears a funny hat
\end{samplesent}
...
To symbolise
\begin{samplesent}
\item\label{q.e} There is a logician who wears glasses
\end{samplesent}
...
To symbolise
\begin{samplesent}
\item\label{q.e} There is a Polish woman who won the Nobel Prize
\end{samplesent}
...
To symbolise
\begin{samplesent}
	\item\label{loveseveryone1} Everyone loves Alice.
\end{samplesent}
...
\begin{samplesent}
	\item\label{loveseveryone2} Alice loves everyone.
\end{samplesent}
...
To symbolise
\begin{samplesent}
	\item\label{lovesesomeonethemselves} Someone loves themselves.
\end{samplesent}
\begin{center}
	\begin{forest}
...
If we want to symbolise
\begin{samplesent}
	\item\label{lovesesomeonethemselves} Some dog likes playing with Finley.
\end{samplesent}
%We can do:
%\begin{equation*}
...
\begin{samplesent}
\item\label{q.dog}Finley is not quiet, but some dog is.
\end{samplesent}
...
Consider also 
\begin{samplesent}
	\item\label{q.dog2}Some dog is quiet but Finley is not
\end{samplesent}
...
Consider:
\begin{samplesent}
\item\label{q.notevery}Not every dog is quiet
\end{samplesent}
