...
\begin{center}
	\begin{forest}
		[Some dog is quiet but Finley is not\\Some dog is quiet \mainconnective{and} Finley is not quiet\\$(\ldots \mainconnective{\eand} \ldots)$
		[Some dog is quiet\\\mainconnective{There is some $x$:} $x$ is a dog and $x$ is quiet\\$\mainconnective{\exists x}\ldots$
		[$x$ is a dog \mainconnective{and} $x$ is quiet\\$(\ldots \mainconnective{\eand} \ldots)$
		[$x$ is a dog\\$Dx$]
		[$x$ is quiet\\$Qx$]
		]
		]
		[Finley is not quiet\\\mainconnective{It is not the case that} Finley is quiet\\$\mainconnective{\enot} \ldots$
		[Finley is quiet\\$Qf$]
		]
		]
	\end{forest}
\end{center}
So we result in: $(\exists x(Dx \eand Qx) \mainconnective{\eand} \enot Qf)$
...
\begin{center}
	\begin{forest}
		[Gerardo is a dog owner\\There is a dog that Gerardo owns\\$\mainconnective{\exists x}(Dx \eand Ogx)$
		[There is some $x$ such that $x$ is a dog and $g$ owns $x$\\$\exists x(Dx \eand Ogx)$
		[$x$ is a dog \mainconnective{and} $g$ owns $x$\\$Dx {\eand} Ogx$
		[$x$ is a dog\\${Dx}$]
		[$g$ owns $x$\\${Ogx}$]
		]
		]
...
\begin{center}
	\begin{forest}
		...
		For every $x$: if $x$ is a dog owner then $x$ is a friend of a dog owner\\$\mainconnective{\forall x}\ldots$
		[if $x$ is a dog owner then $x$ is a friend of a dog owner\\$(\ldots \mainconnective{\eif} \ldots)$
		[$x$ is a dog owner\\$\mainconnective{\exists z}\ldots$
		[$z$ is a dog and $x$ owns $z$\\$(\ldots \mainconnective{\eand} \ldots)$
		[$z$ is a dog\\$Dz$]
		[$x$ owns $z$\\$Oxz$]
		]
		]
		[$x$ is a friend of a dog owner\\$\mainconnective{\exists y}\ldots$
		[$y$ is a dog owner \mainconnective{and} $x$ is a friend of $y$\\$(\ldots \mainconnective{\eand} \ldots)$
		[$y$ is a dog owner\\$\mainconnective{\exists z}\ldots$
		[$z$ is a dog \mainconnective{and} $y$ owns $z$\\$(\ldots \mainconnective{\eand} \ldots)$
		[$z$ is a dog\\$Dz$]
		[$y$ owns $z$\\$Oyz$]
		]
		]
