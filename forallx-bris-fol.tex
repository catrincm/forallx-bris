...
These are symbolised in FOL as $H\yellowbox{x}$ or $\exists y L\yellowbox{x}y$. They are not \emph{sentences} of FOL, but they are well-formed \emph{formulas}. Formulas are the sorts of things that form sentences when you put quantifiers in front of them. Sentences are special kinds of formulas, those which have no so-called free-variables. No additional specification of who $x$ is is needed in $\forall x\, Hx$. It is a sentence. 
