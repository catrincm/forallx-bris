...
In the formation tree of the sentence, the scope of a connective or quantifier is the sub-tree where it is the main logical operator of the formula at the top. Only that subtree is relevant to determining the truth value of that formula under each variable assignment. In this example we have two quantifiers using the variable $y$, $\exists y$ and $\forall y$
