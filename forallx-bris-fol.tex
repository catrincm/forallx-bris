...
It should be immediate why it is important to highlight the domain when symbolizing arguments in FOL: depending on the choice of the domain a sentence like `Everyone has done the problem sheet.' may be true or false and thus the validity of an argument will be affected by the choice of the domain.
