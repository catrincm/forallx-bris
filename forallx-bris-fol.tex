...
We now give the inductive definition of what it is to be a formula of FOL.
	\begin{highlighted}\label{FOLformula}
	\begin{enumerate}
...
\bigskip
	...
	\end{highlighted}\todo{formula is undefined}
...
\begin{highlighted}An occurrance of a variable being \define{free} is defined as follows:
	\begin{itemize}
