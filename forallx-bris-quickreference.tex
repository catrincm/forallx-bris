...
\end{fitchproof}
\begin{itemize}
	\item $c$ not already in the scope of $\forall x$ or $\exists x$ in $X$. 
\end{itemize}
...
\end{fitchproof}
 ...
 \begin{itemize}
	\item 	\meta{c} must not occur in any undischarged assumption
	\item \meta{c} must not already be in the scope of $\forall x$ or $\exists x$ in $\metaX$.
...
\begin{itemize}
	\item Instances of $c$ in the scope of $\forall x$ or $\exists x$ in $X$ must not be replaced. 
\end{itemize}
