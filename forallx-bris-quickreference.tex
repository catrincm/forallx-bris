...
\end{fitchproof}
\begin{itemize}
	\item $c$ not already bound by $\forall x$ or $\exists x$ in $X$. 
\end{itemize}
...
\end{fitchproof}
 ...
 \begin{itemize}
	...
	\item \meta{c} must not already be bound by $\forall x$ or $\exists x$ in $\metaX$.
...
\begin{itemize}
	\item Instances of $c$ bound by $\forall x$ or $\exists x$ in $X$ must not be replaced. 
\end{itemize}
