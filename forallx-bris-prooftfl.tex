...
\chapter{The Basic Rules for TFL Part 1}\label{s:BasicTFL}
...
\myanswer{\begin{fitchproof}
		\hypo{cond}{(A \eor \enot A) \eif B}
		\have{lem}{A \eor \enot A}\LEM
		\have{b}{B}\ifE{cond,lem}
\end{fitchproof}}
\end{enumerate}
...
\chapter{More Basic Rules for TFL: part 2: the first basic rules with subproofs}
