...
The negation elimination rule is quite similar but switches $\metaX$ and $\enot\metaX$. 
...
%To get the system of intuitionist logic, we reject $\enot$E and LEM. We then need to add the rule of explosion as a basic rule. This rule is derivable in our system.
 ...
 $\enot$I introduced a negation, but $\enot$E eliminates a negation. In the conclusion of $\enot$E, there may be no negation symbols.

Some textbooks call this the rule of \emph{indirect proof} or the method of \emph{proof by contradiction}. It allows us to prove something by showing that its negation leads to contradiction. This technique is very common in mathematics.%
\footnote{
