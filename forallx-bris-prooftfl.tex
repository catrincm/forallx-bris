...
The rules we give will mostly be attached to particular connectives. This is something that helps with the way to go about finding proofs and it has some technical benefits.
...
\subsection{Proof by Contradiction} \todo[inline]{I don't really like the term negation elimination for it!! SP is right that students get it wrong all the time about which they're allowed to use and which not. We should let them use this!}% New by SP
...
Here is a demonstration of how we could derive the second De Morgan rule:
 	\begin{pf}
		...
		\open
			...
			\close
%\have{nxtoxx}{\enot \metaX \eif \ered}{\ci{(na)-(c1)}}
			\open
				\hypo{nb}{\enot \metaY}
				\have{c2}{\ered}\ri{b, nb}
			\close
%\have{nytoxx}{\enot \metaY \eif \ered}{\ci{(nb)-(c2)}}
			\have{con2}{\ered}\oe{nab, na-c1, nb-c2}
%			\have{con2}{\ered}\oe{nab,nxtoxx,nytoxx}
		\close
%		\have{abtoxx}{(\metaX \eand \metaY)\eif \ered}\ci{(ab)-(con2)}
...
description={A sentence that can be proved without any premises}
	...
	\begin{pf}
		\open
			...
			\have{red}{\ered}\ri{a, na}
		\close
	\have{conxx}{(A \eand \enot A) \to \ered}{\ci{con-red}}
