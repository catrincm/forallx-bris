...
\begin{fitchproof}
	\have[p]{prem}{A \eand (B \eor C)}
	\have[a]{A}{A} \andE{prem}
	\have[bc]{BorC}{B \eor C} \andE{prem}
	\have[]{goal}{(B \eor C) \eand A} \andI{bc,a}
\end{fitchproof}
\item $(A\eor\enot A)\eif B\,\therefore\, B$
\begin{fitchproof}
	\have[c]{cond}{(A \eor \enot A) \eif B}
	\have[l]{lem}{A \eor \enot A} \LEM
	\have[]{Bres}{B} \ifE{cond,lem}
\end{fitchproof}
\end{enumerate}
...
\open
	...
	\hypo{la}{\enot A}
	\have{lr}{L}\by{R}{l}
	\have{nlr}{\enot L}\by{R}{nl}
	\close
	\have{a2}{A}\by{$\enot$E}{la-nlr}
\close
...
\open
	...
	\have{a}{A}%\andE{ab}
	\have{d}{D}%\ifE{ad, a}
	\have{de}{D \eor E}%\orI{d}
\close
\have{conc}{(A \eand B) \eif (D \eor E)}%\ifI{ab-de}
\end{fitchproof}

\begin{fitchproof}
\hypo{nlcjol}{\enot L \eif (J \eor L)}
\hypo{nl}{\enot L}
\have{jol}{J \eor L}%\ifE{nlcjol, nl}
\open
	\hypo{j}{J}
%	\have{jj}{J \eand J}%\andI{j}
%	\have{j2}{J}%\andE{jj}
	\have{j2}{J}%\Reiteration{j}
\close
\have{jtoj}{J \eif J}%{\ifI{j-j2}}
\open
	\hypo{l}{L}
	\have{red}{\ered}%\ri{l, nl}
	\have{j3}{J}%\re{red}
\close
\have{ltoj}{L \eif J}%{\ifI{l-j3}}
%\have{conc}{J}%\orE{jol, j-j2, l-j3}
\have{conc}{J}%\orE{jol, jtoj, ltoj}
\end{fitchproof}
\end{multicols}
