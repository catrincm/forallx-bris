...
\begin{fitchproof}
	...
	\have[23]{c}{A \eand B} \ai{a, b}\hspace*{1em}
\end{fitchproof}
...
\begin{fitchproof}
	...
	\open
		...
		\have{rl}{\text{Both Alice and Beth came to the party}}\ai{r, l}
		\close
	\have{con}{\parbox[t]{.8\textwidth}{Thus, \emph{if} Beth came to the party, both Alice and Beth came.}}\ci{l-rl}
...
So we have now shown that, on the additional assumption, `$B$', we can obtain `$A \eand B$'. We can therefore conclude that, if `$B$' obtains, then so does `$A \eand B$'. Or, to put it more briefly, we can conclude `$B \eif (A \eand B)$':
	\begin{fitchproof}
		...
		\open
			...
			\have{rl}{A \eand B}\ai{r, l}
			\close
		\have{con}{B\eif(A\eand B)}\ci{l-rl}
	\end{fitchproof}
	...
	\begin{fitchproof}
		\hypo{prem}{(P \eand Q) \eor (P \eand R) }
			\open
				...
				\have{p1}{P}\ae{pq}
			\close
%			\have{pqp}{(P \eand Q) \eif P} {\ci{pq-p1}}
			\open
				\hypo{pr}{P \eand R}
				\have{p2}{P}\ae{pr}
			\close
%			\have{prp}{(P \eand R) \eif P} {\ci{pr-p2}}
...
%		\close
%%		\have{bconc}{B \eif ((A \eand B) \eor (A \eand C))}{\ci{b-abo}}
%		\open
%			\hypo{c}{C}
%			\have{ac}{A \eand C}\ai{a,c}
%			\have{aco}{(A \eand B) \eor (A \eand C)}\oi{ac}
%		\close
%%	\have{cconc}{C \eif ((A \eand B) \eor (A \eand C))}{\ci{c-aco}}
%\have{con}{(A \eand B) \eor (A \eand C)}\oe{boc, b-abo, c-aco}
%%\have{con}{(A \eand B) \eor (A \eand C)}\oe{boc, bconc, cconc}
%	\end{fitchproof}
...
\begin{fitchproof}
	...
	\close
%\have{dconc}{D \eif ((P \eand D) \eor (P \eand \enot D))}{\ci{b-abo}}
	\open
	\hypo{nb}{\enot D}
	\have{anb}{P \eand \enot D}\ai{a, nb}
	\have{anbo}{(P \eand D) \eor (P \eand \enot D)}\oi{anb}
	\close
%\have{ndconc}{\enot D \eif ((P \eand D) \eor (P \eand \enot D))}{\ci{b-abo}}
...
%			\have{nd2}{\enot D}\Reiteration{nd}
		...
		\close
%		\have{ndxx}{\enot D \eif \ered}{\ci{nd-ndr}}
...
%	\have{a2}{A}\by{R}{a}
%\close
%\have{atoa}{A \eif A}{\ci{a-a2}}
%\open
%	\hypo{na}{\enot A}
%	\have{bot}{\ered}\redI{na,nna}
%	\have{a3}{A}\redE{bot}
%\close
%\have{natoa}{\enot A \eif A}{\ci{na-a3}}
%%\have{a4}{A}\orE{lem,a-a2, na-a3}
...
\have{3}{N \eor C}%{\oe{lem,znc,nznc}}
\end{fitchproof}
\end{multicols}
...
%		\have{nb2}{\enot\metaY}\Reiteration{nb}
		...
		\close
%\have{xtoxx}{X \eif \ered}{\ci{(a)-(nb1)}}
...
%	\close
%\have{xtox}{\metaX\eif\metaX}{\ci{(a)-(a1)}}
%	\open
%		\hypo{na}{\enot \metaX}
%		\have{red}{\ered}\ri{na, m}
%		\have{a2}{\metaX}\re{red}
%	\close
%\have{nxtox}{\enot\metaX\eif\metaX}{\ci{(na)-(a2)}}
