...
\begin{samplesent}
	\item\label{negcon1} You won't get both soup and salad.
...
How are we to understand this guideline? Consider the following sentences:
 \begin{samplesent}
		\item\label{not4} The information is retrievable.
		\item\label{not4b} The information is not be retrievable.
		\item\label{not5} The information is irretrievable.
		\item\label{not5b} The information is not irretrievable.
	\end{samplesent}
...
\begin{samplesent}
		\item\label{not6} Stealing is good.
		\item\label{not7} Stealing is bad.
		\end{samplesent}
...
Sometimes even in symbolizing sentences that very much look like they are negations of each other one needs to be careful. Consider:
	\begin{samplesent}
		\item\label{not8} Jane is happy.
		\item\label{not9} Jane is unhappy.
	\end{samplesent}
...
Let's look at some more examples:
	\begin{samplesent}
	        \item\label{and3}Adam is athletic, and Barbara is also athletic.
...
\begin{samplesent}
		\item\label{or1} Fatima will play videogames, or she will watch movies.
		\item\label{or2} Fatima or Omar will play videogames.
	\end{samplesent}
...
\begin{samplesent}
		\item\label{eor1} Either Fatima will play videogames, or she will watch movies.
		\item\label{eor2} Either Fatima will play videogames or Omar will play videogames.
	\end{samplesent}
...
\begin{samplesent}
	\item\label{egsent:excl in cond} If either Fatima or Omar play videogames, then the house will remain a mess.
\end{samplesent}
...
\begin{samplesent}
	\item\label{if1} If the number can be divided by 4, then it is even. 
		\item\label{if3} If it can be divided by 4, it is even. 
		\item\label{if4} It is an even number if it can be divided by 4.
\end{samplesent}
...
Now consider
\begin{samplesent}
		\item\label{if2} The number is an even number only if the number can be divided by 4.
\end{samplesent}
...
In fact, sentence \ref{if2} can be paraphrased as `If Jean is in France, then Jean is in Paris'. So we can symbolize it by $(F \eif P)$: the other way around to \ref{if1}.
	...
	\begin{samplesent}
		\item\label{ifthen1} \mainconnective{If} Alice is on shift \mainconnective{then} Beth is on shift.
		\item\label{ifthen2}  Beth is on shift \mainconnective{if} Alice is.
		\item\label{ifthen3}  Alice is on shift \mainconnective{only if} Beth is.
	\end{samplesent}
...
\begin{samplesent}
\item\label{unless3}  If you do not wear a jacket, then you will catch a cold.
\item\label{unless4}  If you do not catch a cold, then you wore a jacket.
\item\label{unless5} Either you will wear a jacket or you will catch a cold.
\end{samplesent}
...
\begin{samplesent}
	\item\label{scamb1} \emph{Avengers: Endgame} is not: both long and boring.
	\item\label{scamb2} \emph{Avengers: Endgame} is both: not long and boring.
\end{samplesent}
