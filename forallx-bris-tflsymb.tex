...
\begin{earg}
	...
	\item \mainconnective{Either} Alice \mainconnective{or} Beth will come to the party \emph{(and not both)}.  
	...
	\item Alice will come to the party \mainconnective{only if} Beth will.  
	\item Alice will come to the party \mainconnective{if} Beth will not.  
	\item Alice will come to the party \mainconnective{if and only if} Beth will. 
\end{earg}

In this chapter we will discuss how they should be symbolised in TFL.  The feature of TFL is that it can capture any \emph{truth functional} connective (recall \ref{s:TruthFunctionality}), possibly by a more complex structure. 

We will also discuss in more detail when it is appropriate to paraphrase in the cannonical ways. 
