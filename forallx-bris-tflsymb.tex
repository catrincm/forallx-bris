...
\factoidbox{When symbolizing sentences, make sure the paraphrasing matches the truth conditions}
...
\factoidbox{When symbolizing sentences, only introduce logical structure that is displayed by the English sentence}
...
\factoidbox{
	If a sentence can be paraphrased in English as `\emph{neither \ldots nor \ldots}',\\ it can be symbolised as $\enot(\metaX\eor\metaY)$ or as $\enot \metaX\eand\enot \metaY$.}
