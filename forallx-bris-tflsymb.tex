...
\begin{center}
	\begin{forest}
		[You will get both soup and salad\\\ldots and \ldots\\$\textcolor{lightgray}{(}\ldots {\eand} \ldots\textcolor{lightgray}{)}$
		[You will get soup\\?]
		[You will get salad\\?]
		]
	\end{forest}
...
\begin{center}
	\begin{forest}
		...
		[You will get both soup and salad\\\ldots and \ldots\\$\textcolor{lightgray}{(}\textcolor{blue}{S_1} \mainconnective{\eand} \textcolor{blue}{S_2} \textcolor{lightgray}{)}$
		[You will get soup\\$S_1$]
		[You will get salad\\$S_2$]
		]
		]
...
\begin{center}
	\begin{forest}
		...
		[John has a pet\\$P$]
		[John has a cat or a dog\\\ldots or \ldots\\$\ldots\eor\ldots$
		[John has a cat\\$C$]
		[John has a dog\\$D$]
		]]
	\end{forest}
...
\begin{center}
	\begin{forest}
		...
		[John has a pet\\$P$]
		[John has a cat or a dog\\$\textcolor{lightgray}{(}\textcolor{blue}{C}\mainconnective{\eor}\textcolor{blue}{D}\textcolor{lightgray}{)}$
		[John has a cat\\$C$]
		[John has a dog\\$D$]
		]]
	\end{forest}
...
\begin{center}
	\begin{forest}
		...
		[Harry had cake\\$H$]
		[Either Lotta or Karl did not have cake\\\ldots or \ldots\\$\textcolor{lightgray}{(}\ldots\eor\ldots\textcolor{lightgray}{)}$
