...
\begin{highlighted}
	\begin{enumerate}
		\item\label{bpr} Check whether the sentence can be paraphrased as sentences in one of our standard forms. If the answer is no, go to Step \ref{epr}. If the answer is yes, go to Step \ref{cpr}.
