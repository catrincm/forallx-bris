...
We introduced our connectives in \cref{sec:Connectives} giving their rough English meaning. This gives us some tools to know how to symbolise English sentences. As a general instruction:
	\begin{itemize}
...
By symbolising it with one of these connectives, the truth conditions for the sentence is determined in accordance with the truth rule. Symbolising it this way is appropriate when these are appropriate truth conditions; but these standard English paraphrasing is good guidance for when this is the case. 
...
\section{Negation}
Let's start by recalling the guideline we proposed in \cref{sec:SymbolisingTFL - simple connectives complex form}.
\factoidbox{
