...
\begin{samplesent}
	\item\label{inclor} She can understand German or French (or both).
	\item\label{exclor} She can understand German or French (but not both).
\end{samplesent}
...
Consider
\begin{samplesent}
	\item\label{exsent:cond: beer then eighteen} If she is drinking beer, then she is over eighteen.
	\item\label{exsent:cond: eighteen then beer} If she is over eighteen, then she is drinking beer.
\end{samplesent}
...
\end{ekey}
We will then represent \ref{exsent:cond: beer then eighteen} as `$B\eif E$' and \ref{exsent:cond: eighteen then beer} as `$E\eif B$'. 
...
The material conditional is the best that can be done to capture the conditional in a truth-functional way, where the truth can be determined simply from the truth values of its constituent parts. 
 See \url{https://plato.stanford.edu/entries/conditionals} and \ref{s:IndicativeSubjunctive} for further discussion
...
%\begin{samplesent}
%	\item\label{neg-f} Bristol is not in France.
%	\item\label{neg-f} Bristol is not in England.
%\end{samplesent}
...
%\begin{samplesent}
%	\item\label{conj} She can speak German and she can speak French.
%\end{samplesent}
...
%Consider:
%\begin{samplesent}
%	\item\label{conj} She can speak German or she can speak French.
%\end{samplesent}
...
%It seems that in English there are two kinds of disjunctions: an \define{inclusive} and an \define{exclusive} one. For the inclusive \emph{or}, we might whisper a ``or both'' after it; whereas for the exclusive \emph{or}, we'd want to whisper a ``but not both'':
%\begin{samplesent}
%	\item\label{inclor} She can speak German or
%	she can speak French (or both).
%	\item\label{exclor} She can speak German or
...
%\begin{samplesent}
%	\item\label{bartender} If she is drinking a beer, then she is over eighteen.
%\end{samplesent}
...
%\begin{samplesent}
%	\item\label{kangaroo} If Kangaroos had no tails, they would topple over.
%\end{samplesent}
...
\begin{samplesent}
\item\label{engamb1} John's tired, and Sue's tall or Rob's short.
\item\label{engamb2} John's tired and Sue's tall, or Rob's short.
\end{samplesent}
...
\begin{samplesent}
\item\label{mathamb} $9 + 3 \times 4$
\end{samplesent}One could add brackets to this equation to obtain: 
\begin{samplesent}
\item\label{mathamb1} $9 + (3 \times 4) \qquad(=9+12=21)$
\item\label{mathamb2} $(9+3) \times 4 \qquad(=12\times 4=48)$
\end{samplesent}
...
In \ref{s:Truth rules} we gave truth rules for the connectives of TFL. Now we can apply them to complex sentences. 
...
\begin{samplesent}
	\item\label{nec-math} $2 + 2 = 4$
	\item\label{nec-music} Shostakovich wrote fifteen string quartets
\end{samplesent}
...
\begin{samplesent}
	\item\label{brownwins1} If Mitt Romney had won the 2012 election, then he would have been the 45th President of the USA.
	\item\label{brownwins2} If Mitt Romney had won the 2012 election, then he would have turned into a helium-filled balloon and floated away into the night sky.
\end{samplesent}
