...
The truth rules associated with the connectives allow us to calculate the truth value of a complex sentences based on the truth values of its constituent parts, but ultimately we get to the atomic sentences and have to ask whether they are true or false. 
