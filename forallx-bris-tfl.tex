...
For each valuation for $A,B,C$ there is a version of it where $P_{235}$ is true, and another where $P_{235}$ is false. We thus duplicate each line of the table so far and add these two possible truth values for $P_{235}$ in the two variants. 
