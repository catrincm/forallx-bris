...
As we highlighted, the order matters. So lets consider `$E\eif B$'? How does it differ from $B\eif E$? We can apply this rule, but we have to be careful which order to apply it in. To help make sure we apply it in the right order, it might be helpful to copy down the values for $E$ and $B$ before applying the rule: 
\begin{center}
