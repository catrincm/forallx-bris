...
In what cases is `$B\eif E$' true or false?
\begin{center}
	\begin{tabular}{rccl}
		&$B$&$E$\\\hline
		$v_1$&T&T&She is drinking beer and is over eighteen\\
		$v_2$&T&F&She is drinking beer and is under eighteen\\
		$v_3$&F&T&She is not drinking beer and she is over eighteen\\
		$v_4$&F&F&She is not drinking beer and she is under eighteen\\
	\end{tabular}
\end{center}
...
\begin{definition}\label{def:Truthint}
...
\end{samplesent}
	...
	We use brackets to identify how to read the sentence, but to know where they belong they come from the formation rules for the sentences of TFL. 
