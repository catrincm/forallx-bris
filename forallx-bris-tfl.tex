...
In which cases is `$\enot A$' true? Only when `$A$' is false: 
\begin{center}
	\begin{tabular}{c|c}
...
She can understand German or French, and it's not the case that she can understand both. 
...
So far, we have only  focused on the application of the connectives to atomic sentences, but they can be applied to sentences which already contain connectives. 
...
\section{Sentences}\label{sec:TFLSentences}
