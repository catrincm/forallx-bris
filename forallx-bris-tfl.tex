...
\begin{enumerate}
\item[1.] Tells us that atomic sentences as discussed in \cref{sec:as} are sentence of TFL.
\end{enumerate}
...
\end{forest}
\end{center}
The different formations will be important when we describe truth-tables for these sentences (\cref{sec:tt}). $((A\eand B)\eor C)$ and $(A\eand (B\eor C))$ will differ in when they are true.
...
One of our main purposes for using TFL is to study arguments, and that will be our concern in \cref{sec:tt}. In English, the premises of an argument are often expressed by individual sentences, and the conclusion by a further sentence. Since we can symbolize English sentences, we can symbolize English arguments using TFL.
