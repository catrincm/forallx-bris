...
\chapter{Complex sentences of TFL}
...
\begin{center}
	\begin{forest}
		[$\textcolor{lightgray}{(} (A\eand B)\mainconnective{\eor} C\textcolor{lightgray}{)} $
		[$\textcolor{lightgray}{(} A\mainconnective{\eand} B\textcolor{lightgray}{)} $[$A$][$B$]]
		[$C$]
		]
	\end{forest}
\end{center}
...
\begin{center}
	\begin{forest}
		...
		[$\textcolor{lightgray}{(} A\mainconnective{\eor}B\textcolor{lightgray}{)} $
		[$A$][$B$]
		]
		]
	\end{forest}
...
\begin{center}
	\begin{forest}
		...
		[$\mainconnective{\enot} (A\eand B)$[$A\eand B$[$A$][$B$]]]
		[$C$]
		]
	\end{forest}
\end{center}
...
\begin{center}
	\begin{forest}
		[{$\mainconnective{\enot} (\enot (\enot Q\eif (R\eand S))\eand \enot \enot (P\eor Q))$}
			[{$\textcolor{lightgray}{(}\enot (\enot Q\eif (R\eand S))\mainconnective{\eand} \enot \enot (P\eor Q)\textcolor{lightgray}{)}$}
				[{$\mainconnective{\enot} (\enot Q\eif (R\eand S))$}
					[{$\textcolor{lightgray}{(}\enot Q\mainconnective{\eif}(R\eand S)\textcolor{lightgray}{)}$}
						[{$\mainconnective{\enot} Q$}
							[{$Q$}]
						]
						[{$\textcolor{lightgray}{(}R\mainconnective{\eand}S\textcolor{lightgray}{)}$}
							[{$R$}]
							[{$S$}]
						]
					]
				...
				[{$\mainconnective{\enot}\enot (P\eor Q)$}
					[{$\mainconnective{\enot} (P\eor Q)$}
						[{$\textcolor{lightgray}{(}P\mainconnective{\eor}Q\textcolor{lightgray}{)}$}
							[{$P$}]
							[{$Q$}]
						]
					]
