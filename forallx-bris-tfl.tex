...
\begin{center}
	\begin{tabular}{rl}
	$\enot A$&\mainconnective{It is not the case that} it is raining outside. \\
	&(Alternatively, it is not raining outside).\\\Tstrut
		$A\eand C$& It is raining outside \mainconnective{and} Jenny is miserable.\\\Tstrut
	$A\eor C$&It is raining outside \mainconnective{or} Jenny is miserable.\\\Tstrut
	 $A\eif C$&\mainconnective{If} it is raining outside, \mainconnective{then} Jenny is miserable.
\end{tabular}
\end{center}
...
We can use TFL to consider sentences with more complex logical structure. 
For example:
\begin{gather*}
	\enot(A\eand B)\\
...
These are sentences which we will use to symbolise:
\begin{samplesent}
...
\begin{center}
	\begin{forest}
		...
		[$\atomicstage{A}$\\Alice is happy][$\atomicstage{B}$\\Beth is happy]
		]
		]
	\end{forest}
...
We will use the sentence $\enot (A\eand B)$ to be the symbolisation of and English sentence:
\begin{samplesent}
	\item 	It is not the case that both Alice and Beth are happy.
\end{samplesent}
...
What about $\enot(A\eand B)$? This will make use of our truth rule for $\enot$, the only difference now is that it is applied not to an atomic sentence but something that is more complicated. Recall the truth rule for $\enot$: 
\begin{center}
	\begin{tabular}{ccc}
	If \metaX is:&&then $\enot\metaX$ is:\\
	T &$\leadsto$& F\\
...
So suppose we are in a case where neither Alice nor Beth are happy ($v_4$). Then $(A\eand B)$ is false. So $\enot(A\eand B)$ is true. To keep track of this reasoning in the four possibilities, we write the truth value of the sentence underneath its main connective, in this case, $\enot$. 
\begin{center}
...
\begin{center}
	\begin{forest}
		...
		[$(A\mainconnective{\eor} B)$[$\atomicstage{A}$][$\atomicstage{B}$]]
		[$\mainconnective{\enot}(A\eand B)$
		[$(A\mainconnective{\eand} B)$[$\atomicstage{A}$][$\atomicstage{B}$]]
		]
				]
	\end{forest}
\end{center}
...
\begin{center}
	\begin{forest}
		...
		[$(A\mainconnective{\eor} B)$\\\ldots or \ldots[$\atomicstage{A}$\\Alice is happy][$\atomicstage{B}$\\Beth is happy]]
		[$\mainconnective{\enot}(A\eand B)$\\It is not the case that \ldots
		[$(A\mainconnective{\eand} B)$\\\ldots and \ldots [$\atomicstage{A}$\\Alice is happy][$\atomicstage{B}$\\Beth is happy]]
		]
		]
	\end{forest}
\end{center}
...
With some English guidance this can be understood as:
		...
		\begin{forest}
			...
			[$(A\mainconnective{\eand} B)$\\\ldots and \ldots[$\atomicstage{A}$\\Alice is happy][$\atomicstage{B}$\\Beth is happy]]
			[$\atomicstage{C}$\\Charlie is happy]
			]
		\end{forest}
	\end{center}
...
\end{samplesent}
	...
	$$A\eif(\enot B)\qquad\leadsto \text{wrong!}$$
...
\begin{center}
	\begin{forest}
		...
		[$\textcolor{lightgray}{(} A\mainconnective{\eand} B\textcolor{lightgray}{)} $[$\atomicstage{A}$][$\atomicstage{B}$]]
		[$\atomicstage{C}$]
		]
	\end{forest}
\end{center}
...
\multirow{4}{*}{Valuation}	&	\multirow{4}{*}{$H$}&\multirow{4}{*}{$I$}	& $($ & $\enot$ & $I$ & $\eand$ & $H$ & $)$ & \tikzmarknode{tt1_imp}{$\mainconnective{\eif}$} & $H$ \\[.4em]
	&	& & $\mainconnectivecolor{(}$ & $\enot$ & $I$ & \tikzmarknode{tt1_and}{$\mainconnective{\eand}$} & $H$ & $\mainconnectivecolor{)}$ & &\tikzmarknode{tt1_Hr}{$\atomicstage{H}$} \\[.4em]
	&	& & & \tikzmarknode{tt1_not}{$\mainconnective{\enot}$} & $I$  & & \tikzmarknode{tt1_Hl}{$\atomicstage{H}$} & & &\\[.4em]
	&	& & & & \tikzmarknode{tt1_I}{$\atomicstage{I}$}& & & & &  \\\hline 
	$v_1:$&T&T&\\
	$v_2:$&T&F&\\
	$v_3:$&F&T\\
	$v_4:$&F&F
...
\begin{center}
	\begin{tabular}{r c c| d e e ee e e fc}
		...
		&	& & $\mainconnectivecolor{(}$ & $\enot$ & $I$ & \tikzmarknode{tt2_and}{$\mainconnective{\eand}$} & $H$ & $\mainconnectivecolor{)}$ & &\tikzmarknode{tt2_Hr}{$\atomicstage{H}$} \\[.4em]
		&	& & & \tikzmarknode{tt2_not}{$\mainconnective{\enot}$} & $I$  & & \tikzmarknode{tt2_Hl}{$\atomicstage{H}$} & & &\\[.4em]
		&	& & & & \tikzmarknode{tt2_I}{$\atomicstage{I}$}& & & & & &$\star$ \\\hline 
		$v_1:$&T&T& & &T& & & & &\\
		$v_2:$&T&F& & &F& & & & &\\
		$v_3:$&F&T& & &T& & & & &\\
		$v_4:$&F&F& & &F& & & & &\\
...
\begin{center}
	\begin{tabular}{r c c| d e e ee e e f c}
		...
		&	& & $\mainconnectivecolor{(}$ & $\enot$ & $I$ & \tikzmarknode{tt3_and}{$\mainconnective{\eand}$} & $H$ & $\mainconnectivecolor{)}$ & &\tikzmarknode{tt3_Hr}{$\atomicstage{H}$} & \\[.4em]
		&	& & & \tikzmarknode{tt3_not}{$\mainconnective{\enot}$} & $I$  & & \tikzmarknode{tt3_Hl}{$\atomicstage{H}$} & & & & $\star$ \\[.4em]
		&	& & & & \tikzmarknode{tt3_I}{$\atomicstage{I}$}& & & & &  & \\\hline 
		$v_1:$&T&T& & &T& &T& & & &\\
		$v_2:$&T&F& & &F& &T& & & &\\
		$v_3:$&F&T& & &T& &F& & & &\\
		$v_4:$&F&F& & &F& &F& & & &\\
...
\begin{center}
	\begin{tabular}{r c c| d e e ee e e fc}
		...
		&	& & $\mainconnectivecolor{(}$ & $\enot$ & $I$ & \tikzmarknode{tt4_and}{$\mainconnective{\eand}$} & $H$ & $\mainconnectivecolor{)}$ & &\tikzmarknode{tt4_Hr}{$\atomicstage{H}$} \\[.4em]
		&	& & & \tikzmarknode{tt4_not}{$\mainconnective{\enot}$} & $I$  & & \tikzmarknode{tt4_Hl}{$\atomicstage{H}$} & & &&$\star$\\[.4em]
		&	& & & & \tikzmarknode{tt4_I}{$\atomicstage{I}$}& & & & &  \\\hline 
		$v_1:$&T&T& &F&T& &T& & &\\
		$v_2:$&T&F& &T&F& &T& & &\\
		$v_3:$&F&T& &F&T& &F& & &\\
		$v_4:$&F&F& &T&F& &F& & &\\
...
\begin{center}
	\begin{tabular}{r c c| d e e ee e e f c}
		...
		&	& & $\mainconnectivecolor{(}$ & $\enot$ & $I$ & \tikzmarknode{tt5_and}{$\mainconnective{\eand}$} & $H$ & $\mainconnectivecolor{)}$ & &\tikzmarknode{tt5_Hr}{$\atomicstage{H}$}&$\star$ \\[.4em]
		&	& & & \tikzmarknode{tt5_not}{$\mainconnective{\enot}$} & $I$  & & \tikzmarknode{tt5_Hl}{$\atomicstage{H}$} & & &\\[.4em]
		&	& & & & \tikzmarknode{tt5_I}{$\atomicstage{I}$}& & & & &  \\\hline 
		$v_1:$&T&T& &F&T&F&T& &&T\\
		$v_2:$&T&F& &T&F&T&T& &&T\\
		$v_3:$&F&T& &F&T&F&F& &&F\\
		$v_4:$&F&F& &T&F&F&F& &&F\\
...
\begin{center}
	\begin{tabular}{r c c| d e e ee e e fc}
		...
		&	& & $\mainconnectivecolor{(}$ & $\enot$ & $I$ & \tikzmarknode{tt6_and}{$\mainconnective{\eand}$} & $H$ & $\mainconnectivecolor{)}$ & &\tikzmarknode{tt6_Hr}{$\atomicstage{H}$} \\[.4em]
		&	& & & \tikzmarknode{tt6_not}{$\mainconnective{\enot}$} & $I$  & & \tikzmarknode{tt6_Hl}{$\atomicstage{H}$} & & &\\[.4em]
		&	& & & & \tikzmarknode{tt6_I}{$\atomicstage{I}$}& & & & &  \\\hline 
		$v_1:$&T&T& &F&T&F&T& &\TTbf{T}&T\\
