...
Consider this argument:
\begin{earg}
	\prem If Ava studies, then Ava passes.
	\prem Ava passes.
	\conc Ava studies.
\end{earg}
...
\begin{definition}
	\begin{itemize}
		...
		$P\eand Q\eif R\eor S$  is an abbreviation of  $(P\eand Q)\eif (R\eor S)$
		...
		$P\eand Q\eand R$  is an abbreviation of  $(P\eand Q)\eand R$.\\
