...
\item Kevin is a lecturer, whereas Kevin names Kevin, which is an expression of the language and not a lecturer.
\end{enumerate}
...
\end{itemize}
Is `Sharky' used or mentioned in the above sentence.
\end{practiceproblems}
