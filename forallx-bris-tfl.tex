...
\begin{itemize}
\item $\enot A$\\\mainconnective{It is not the case that} it is raining outside. \\(Alternatively, it is not raining outside).
\item $A\eor C$\\It is raining outside \mainconnective{or} Jenny is miserable.
\item $A\eif C$\\\mainconnective{If} it is raining outside, \mainconnective{then} Jenny is miserable.
...
Again whether this is true will depend on $G$ and $F$
\begin{center}
	\begin{tabular}{rccl}
		&$G$&$F$\\\hline\Tstrut
		...
		$v_4$&F&F&She neither understands German nor French\\
	\end{tabular}
\end{center}
...
\ref{exsent:cond: beer then eighteen} 
...
Again whether this is true will depend on the truth value of `$B$' and `$E$'
\begin{center}
	\begin{tabular}{rccl}
		&$B$&$E$\\\hline
	...
	\end{tabular}
\end{center}
In what cases is `$B\eif E$' it true or false?

In $v_1$ it is true. In $v_2$ it is false. In $v_3$ it is true.
\begin{center}
	\begin{tabular}{rcc|c}
		&$B$&$E$&$B\eif E$\\\hline
		$v_1$&T&T&T\\
