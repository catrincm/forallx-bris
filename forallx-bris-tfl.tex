...
To emphasize, then:
	\factoidbox{
	  $\metaX$ is a symbol (called a \define{metavariable}) in augmented English, which we use to talk about any expression of our formal language. 	$A$ is a particular atomic sentence of TFL.}
