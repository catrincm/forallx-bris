...
\usepackage[textbook]{forallxbris}
\usepackage{setup/meta}
...
\setstocksize{210mm}{148mm} % CCM: setting it to a5 paper gives larger margins than RZ. Which I like! RZ had: 
...
\begin{textblock*}{0in}(0in,0in)
  ...
  \begin{minipage}[b][\stockheight][s]{.9\stockwidth}
    \begin{raggedleft}
      ...
      \color{black}
      \textbf{\uppercase{Bristol}\\ (Accessible)}
