...
Perhaps we meant to say:
	\begin{samplesent}
		...
		\item\label{else1d} Pavel owes money to everyone \emph{except} Pavel himself
	\end{samplesent}
...
\begin{samplesent}
\item\label{superman1b} Clark Kent and Superman are the same person.
\item\label{superman1c} Clark Kent is identical to Superman.
\end{samplesent}
...
\begin{samplesent}
\item\label{else3} No one besides Pavel owes money to Hikaru.
\item\label{else4} Only Pavel owes Hikaru money.
\end{samplesent}
